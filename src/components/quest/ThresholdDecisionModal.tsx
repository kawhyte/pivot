    ...
    <>
      ...
      <div className="duo-modal">
        ...
        <motion.div
          ...
          className="mb-6 rounded-xl bg-neutral-100 px-4 py-3 text-center"
        >
        ...
        <motion.div
          ...
          className="mb-4 text-center text-sm font-semibold text-neutral-500"
        >
          Choose your path:
        </motion.div>
        ...
        <motion.button
          ...
          className="duo-button w-full py-4 text-neutral-900"
          style={{
