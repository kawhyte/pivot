        ...
        {stats.isBonusUnlocked === false && (
          ...
          >
            <div className="flex items-center justify-center gap-2 mb-2">
              ...
              <p className="font-bold text-orange-900 uppercase tracking-wide text-xl">Sudden Death Attempt </p>
              <Zap className="h-5 w-5 text-orange-600" />
            </div>
            <p className="mt-2 text-base text-center text-neutral-600 font-medium">
              "Oh no! The Perfect Run was cut short. Even Monica Geller would need a moment after that one!
            </p>
            <div className="flex items-center justify-center gap-2">
              <Award className="h-4 w-4 text-green-600" />
              <p className="text-lg font-semibold text-green-700">Base Key Secured ✓</p>
            </div>
          </motion.div>
        )}
